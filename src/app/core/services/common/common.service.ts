...
export class CommonService {
  public leftsidebarvalue: BehaviorSubject<any> = new BehaviorSubject<any>(false);
  public leftsidebar: Observable<[]> = this.leftsidebarvalue.asObservable();

  public rightsidebarvalue: BehaviorSubject<any> = new BehaviorSubject<any>(false);
  ...
  righttoggle() {
    console.log(this.rightsidebarvalue.value);
